...
前回は Hiroaki Sasaki さんの [React Native の Web View と Webブラウザにおけるビデオ通話の再生ポリシーの違い](https://adventar.org/calendars/11601) でした。
...
今回のダイエットで痛感したのは、**意志より「仕組み」のほうが強い**ということ。
